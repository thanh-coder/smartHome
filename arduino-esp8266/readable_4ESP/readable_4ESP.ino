...
const char* ssid = "1234";          //Tên mạng Wifi mà Socket server của bạn đang kết nối
const char* password = "123456788";  //Pass mạng wifi ahihi, anh em rãnh thì share pass cho mình với.
 
char host[] = "192.168.43.203";  //Địa chỉ IP dịch vụ, hãy thay đổi nó theo địa chỉ IP Socket server của bạn.
